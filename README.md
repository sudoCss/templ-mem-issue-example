...
Include popular icons in your Go [Templ](https://templ.guide/) projects easily with templicons, which allows you to include the icons that your project is using.
